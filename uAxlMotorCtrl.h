...
#ifndef uAxlMotorCtrlH
#define uAxlMotorCtrlH
//---------------------------------------------------------------------------
...
CAxlMotorCtrl Class
========================================================================== */
class CAxlMotorCtrl : public CMotorCtrl
{
	long GetSearchSignalValue(const BYTE signal);
	long GetSearchSignalEdge(const BYTE byEdge);

public:
	CAxlMotorCtrl(const int nCard);
	virtual ~CAxlMotorCtrl();

	static CMotorCtrl *__stdcall Create(const int nCard) { return new CAxlMotorCtrl(nCard); }
